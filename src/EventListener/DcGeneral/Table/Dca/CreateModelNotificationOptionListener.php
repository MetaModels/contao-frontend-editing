...
/**
 * This listener collect options for the property create model notification.
 */
final class CreateModelNotificationOptionListener extends AbstractNotificationOption
{
    /**
     * {@inheritDoc}
     */
    ...
    protected function notificationType(): string
    {
        ...
        if (!\class_exists(Terminal42NotificationCenterBundle::class, true)) {
            return 'mm_fe_create_model';
        }
        return 'mm_fe_model_create';
    }
}
