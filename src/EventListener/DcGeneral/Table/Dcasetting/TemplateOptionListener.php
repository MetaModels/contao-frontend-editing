...
namespace MetaModels\ContaoFrontendEditingBundle\EventListener\DcGeneral\Table\Dcasetting;
 ...
 */
final class TemplateOptionListener
{
    /**
    ...
    {
        if (!$this->wantToHandle($event) || ($event->getPropertyName() !== 'fe_template')) {
            return;
        }

        $event->setOptions($this->templateList->getTemplatesForBase('form_'));
    }
